...
def scrape_flipkart_search(max_pages=None, search_query='car'):
    ...
    Extract all Pages & apply Multi Threading which reduvce the time of execution
    '''
    ...
    while page <= max_pages:
        ...
        if links:
            ...
            for product_link in product_links:
                t = threading.Thread(target=scrape_flipkart_page, args=(product_link, product_data_list))
                t.start()
                threads.append(t)
